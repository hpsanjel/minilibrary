...
async function sendFineClearedEmail({ to, userName, bookTitle, bookAuthor, fineAmount, transactionId, totalAmount, transactionCount }) {
	try {
		...
		const isMultipleTransactions = totalAmount && transactionCount;
		const displayAmount = isMultipleTransactions ? totalAmount : fineAmount;

		const mailOptions = {
			from: `Mini Library <${process.env.EMAIL_USER}>`,
			to: to,
			subject: isMultipleTransactions ? "All Fines Cleared - Thank You!" : "Fine Payment Confirmed - Thank You!",
			html: `
				<!DOCTYPE html>
				<html>
				<head>
				...
				<body>
					<div class="container">
						<div class="header">
							...
							<h1 style="margin: 0;">${isMultipleTransactions ? "All Fines Cleared!" : "Fine Payment Confirmed!"}</h1>
						...
						<div class="content">
							...
							<p>We have successfully ${isMultipleTransactions ? "cleared all your outstanding fines" : "received and processed your fine payment"}. Your account is now clear and in good standing.</p>
							
							<div class="book-info">
								<h3 style="margin-top: 0; color: #059669;">${isMultipleTransactions ? "💰 Payment Summary" : "📚 Book Details"}</h3>
								${
									isMultipleTransactions
										? `<p><strong>Total Amount Cleared:</strong> ${displayAmount} NOK</p>
									<p><strong>Number of Transactions:</strong> ${transactionCount}</p>
									<p><strong>Status:</strong> All fines cleared</p>`
							...
							<div class="amount">
								Amount ${isMultipleTransactions ? "Cleared" : "Paid"}: ${displayAmount} NOK
							</div>
							...
							<div style="background: #ecfdf5; border: 1px solid #d1fae5; border-radius: 8px; padding: 20px; margin: 20px 0;">
								...
								<ul style="color: #047857; margin: 0;">
									<li>${isMultipleTransactions ? "All your fines have been completely cleared" : "Your fine has been completely cleared"}</li>
							...
							<p>Thank you for being a valued member of our library community. We appreciate your ${isMultipleTransactions ? "cooperation in clearing all outstanding fines" : "prompt payment"} and responsible library usage.</p>
